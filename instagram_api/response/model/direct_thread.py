...
__all__ = ['DirectThread', 'DirectThreadInterface']


class DirectThreadInterface(ApiInterfaceBase):
    thread_id: int
    thread_v2_id: int
    users: [User]
    left_users: [User]
    ...
    last_activity_at_secs: AnyType


class DirectThread(PropertyMapper, DirectThreadInterface):
    pass
